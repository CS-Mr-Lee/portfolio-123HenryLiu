...
public class MusicService {
  ...
  */
  public String toString() {
    ...
    profileDetails += "Your profile information:\n\n";
    ...
    if (this.subscribed == true) {
      profileDetails += "You are subscribed to this music streaming service, enjoy music on the go!\n";
    } else {
      profileDetails += "You are using the free version of this music streaming service, many features are strongly limited!\n";
    }
